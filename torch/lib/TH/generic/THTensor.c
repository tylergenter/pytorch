...
static void THTensor_(rawSet)(THTensor *self, THStorage *storage, ptrdiff_t storageOffset, int nDimension, int64_t *size, int64_t *stride);
static void THTensor_(rawResize)(THTensor *self, int nDimension, int64_t *size, int64_t *stride);
...
THTensor *THTensor_(newWithStorage)(THStorage *storage, ptrdiff_t storageOffset, THLongStorage *size, THLongStorage *stride)
{
  ...
  THTensor_(rawSet)(self,
                    storage,
                    storageOffset,
                    (int) (size ? size->size : (stride ? stride->size : 0)),
                    (size ? size->data : NULL),
...
#endif
  THTensor_(rawResize)(self, (int) size->size, size->data, (stride ? stride->data : NULL));
}
...
void THTensor_(setStorage)(THTensor *self, THStorage *storage_, ptrdiff_t storageOffset_, THLongStorage *size_, THLongStorage *stride_)
{
  ...
  THTensor_(rawSet)(self,
                    storage_,
                    storageOffset_,
                    (int) (size_ ? size_->size : (stride_ ? stride_->size : 0)),
