...
THTensor *THSTensor_(toDense)(THSTensor *self) {
  int d, k, l, index;
  ptrdiff_t nnz;
  int64_t nDimI, nDimV, indskip, blocksize = 1;
  int64_t *sizes;
...
void THSTensor_(copySlice)(
  ...
  int64_t dim, int64_t dstIdx, int64_t srcIdx) {
  if (src->nDimension > 1) {
...
void THSTensor_(reorder)(THSTensor *self) {
  ...
  */
  ...
  int64_t d, i, j, p, cmp, nDimI, nDimV, indskip, tmplong;
  real tmpreal;
